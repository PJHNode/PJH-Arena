...
window.PROPERTY_ICONS = {
  ...
  // 고렙 확장 8종("property 종류를 더 많이 추가해줘 고렙까지 커버 가능하도록" 요청 반영) —
  // stellar_engine 위로 이어지는 만큼 지금까지보다 한 단계 더 정교하게 그렸다.
  von_neumann_swarm: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><rect x="10" y="10" width="4" height="4"/><rect x="2.5" y="2.5" width="3" height="3"/><rect x="18.5" y="2.5" width="3" height="3"/><rect x="2.5" y="18.5" width="3" height="3"/><rect x="18.5" y="18.5" width="3" height="3"/><path d="M10 10L5.5 5.5M14 10l4.5-4.5M10 14l-4.5 4.5M14 14l4.5 4.5"/></svg>',
  dark_matter_refinery: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M12 3l7 4v10l-7 4-7-4V7z"/><circle cx="12" cy="12" r="5.5" stroke-dasharray="1.5 1.5"/><circle cx="12" cy="12" r="2.6" fill="currentColor" stroke="none"/></svg>',
  neutron_star_tap: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="2.5" fill="currentColor" stroke="none"/><path d="M12 1v6M12 17v6M1 12h6M17 12h6"/><path d="M4 4l4 4M16 16l4 4M4 20l4-4M16 8l4-4"/></svg>',
  kardashev_array: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><circle cx="12" cy="12" r="2" fill="currentColor" stroke="none"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="10"/><circle cx="12" cy="2" r="1.2" fill="currentColor" stroke="none"/><circle cx="22" cy="12" r="1.2" fill="currentColor" stroke="none"/><circle cx="12" cy="22" r="1.2" fill="currentColor" stroke="none"/><circle cx="2" cy="12" r="1.2" fill="currentColor" stroke="none"/></svg>',
  multiverse_ledger: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><rect x="3" y="6" width="10" height="13" rx="1"/><rect x="8" y="3" width="10" height="13" rx="1"/><path d="M6 10h4M6 13h4M6 16h4M11 7h4M11 10h4M11 13h4"/></svg>',
  reality_compiler: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M9 3C6 3 5 5 5 8s1 3 1 4-1 1-1 4 1 5 4 5"/><path d="M15 3c3 0 4 2 4 5s-1 3-1 4 1 1 1 4-1 5-4 5"/><circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none"/></svg>',
  omniscience_engine: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4"><path d="M2 12s4-7 10-7 10 7 10 7-4 7-10 7-10-7-10-7z"/><circle cx="12" cy="12" r="3.2"/><circle cx="12" cy="12" r="1" fill="currentColor" stroke="none"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2"/></svg>',
  last_server: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="6" y="2" width="12" height="20" rx="1.5"/><path d="M6 8h12M6 14h12"/><circle cx="9" cy="5" r="0.8" fill="currentColor" stroke="none"/><circle cx="9" cy="11" r="0.8" fill="currentColor" stroke="none"/><circle cx="9" cy="17" r="0.8" fill="currentColor" stroke="none"/></svg>',
};
